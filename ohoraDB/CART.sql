...
EXECUTE UP_CARTLIST_ADD(1001, 176, NULL, 1);
--                      회원 상품 옵션 수량
...
EXECUTE UP_CARTLIST_PRICE(1001);
--                    회원


EXECUTE UP_CARTLIST_UPDATE (1001, 1, 2);


-- 장바구니에서 상품 수량 제어 (수량을 1 미만으로 감소시키려는 경우)

EXECUTE UP_CARTLIST_UPDATE (1001, 176, 1);
--                          회원 상품 수량
...
--                          회원 상품 선택여부
EXECUTE UP_CARTLIST_SELECT (1001, 168,'N');
